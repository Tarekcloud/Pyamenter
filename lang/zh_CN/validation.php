...
return [
    ...
    */
    ...
    'alpha_dash' => ':attribute 只能包含字母、数字、短横线（-）和下划线（_）。',
    ...
    'password' => [
        ...
        'uncompromised' => '提供的 :attribute 曾在数据泄露中出现过，请更换其他 :attribute。',
    ],
