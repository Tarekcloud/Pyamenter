...
class ReferralUserDetailResourceTable extends TableWidget
{
    use InteractsWithPageFilters;

    protected static bool $isDiscovered = false;

    protected static ?string $heading = 'Resource Breakdown';
    ...
    protected function getTableQuery(): Builder | Relation | null
    {
        ...
        if ($codeIds->isEmpty()) {
            return ReferralCommission::query()->whereRaw('1 = 0');
        }
        ...
        return ReferralCommission::query()
            ...
            ->whereIn('ext_referral_commissions.referral_code_id', $codeIds)
