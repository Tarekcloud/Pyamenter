    ...
    >
        <template x-for="item in selectableItems" :key="item.value">
            <li
                ...
                :class="{ 'bg-primary/60': selectableItemIsActive(item) }"
                class="relative py-2 pl-8 pr-4 cursor-pointer select-none hover:bg-primary/60"
            >
                <span 
                ...
                <span
                    ...
                    class="absolute inset-y-0 left-0 flex items-center pl-2 text-primary font-bold"
                >
